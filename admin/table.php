...
<body>
  ...
  <div class="popup <?php if ($ghr == "") echo "hide"; ?>" style="margin-top: -62px;">
    <form action="<?php echo $_SERVER['PHP_SELF'] ?>" method="post" style="width: 580px" enctype="multipart/form-data">
        ...
        <div class="fields">
          ...
          <div class="fields" style="width: 580px">
            <div class="inputs">
              ...
              <input type="text" name="name" placeholder="tableXX" required />
            </div>
            <div class="inputs">
